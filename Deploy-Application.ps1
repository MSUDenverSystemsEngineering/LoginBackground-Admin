...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Copy-File -Path "$dirFiles\defaultBackground.jpg" -Destination "${envSystem32Directory}\oobe\info\backgrounds\defaultBackground.jpg"
		Set-RegistryKey -Key "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Authentication\LogonUI\Background" -Name "OEMBackground" -Value 1 -Type DWord
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBg6VacGqjV+kA3
# I57GKYepGW3X/dkY1TwWpsi6o+KwOaCCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEILbJ
# FmHiPvwxOvFuPAOLXWCAMTi5GtbvHkEzhCGEtwxuMA0GCSqGSIb3DQEBAQUABIIB
# AHvf/3Pii7+s/afYA71xo2470wt/UgKM/RCh/ZSr7KIX1MZ+y6nRjELqlFUgEWKs
# o3fTipIyZgq6vf3upvG/3IY8Bdj2551DpyqdhyX/WvL1W4G1VlPeXn34ouBxHNbW
# rC2Tpx06efUVT8QmSPqEUrJ7oAruBgORgasoOJ5lWWLha1wVbO8TfYeqHvPn5bQy
# eoKxWBhMNQfrkATnPPuMTLXKLnGVObeF/djMhsgXphKli0lX71jkeCbZgCdEEHS0
# Q+AdyVDNqUZTYgwk+5astIF08O7MqYx/DI8azmdELQwDKun35vgtN73oN01v8DAh
# er2/+5jCBJYhw0+0mTbnzC2hggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTgwMTEyMTcwNTQ0WjAjBgkqhkiG9w0BCQQxFgQU
# 1mQtWvCvNoYLvpa2yjA3iRKbGoUwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAGdum+a5oxZ0S/EkSpuC0OBCFKpC/jwu+r+B0m0au1fypnfSNOqnylHq
# WAJh02zC3tCcPwdpHKZeWym9i0FAQq4iWAYYgzUGMGLvYGSKo4iOkaO4/No0/jss
# P3jZqmsnpnTuurBw3eEM3cgVKXTlvxeVAg2zQ2LR7wo39WcRbaBJdno7TcFe7pHM
# kvW6mJDjoIhxQjlaV6f+Tv/9l/e8mFjCeuzS8nn8dxLW3x1vmgiu32DoQgEPZ0Js
# z9OizzQvrh9Qxk8fDeSM9meucCYyv8UD7xN3kWQDytOvp6Yqx3W99muTun5OtiG0
# I7Xus2xkuMWj55OxM5bR2AtWIJUZ1rY=
